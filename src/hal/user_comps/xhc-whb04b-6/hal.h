...
public:
    ...
    public:
        ...
        //! to be connected to \ref halui.mode.is-dro-in-absolute-position
        hal_bit_t* isDroInAbsolutePosition{nullptr};
...
public:
    ...
    //! Returns whether the machine in absolute positioning mode.
    //! \sa HalMemory::In::isDroInAbsolutePosition
    //! \return true if machine dro is in , false otherwise
    bool getIsDroInAbsolutePosition() const;
